...
TEAM_POLICE = DarkRP.createJob("Civil Protection", {
	...
	weapons = {"arrest_stick", "unarrest_stick", "weapon_glock2", "stunstick", "door_ram", "weaponchecker", "weapon_fists"},
	command = "cp",
	max = 4,
...
TEAM_CHIEF = DarkRP.createJob("Civil Protection Chief", {
	...
	weapons = {"arrest_stick", "unarrest_stick", "weapon_deagle2", "stunstick", "door_ram", "weaponchecker", "weapon_fists"},
	command = "chief",
	max = 1,
